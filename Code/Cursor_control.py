# BCI cursor control 
# input: list of detected frequencies 
# output: cursor that moves on screen based on those frequencies
...
frequency_list = [15, 6, 10, 7.5, 10, 6, 15, 6, 15, 7.5, 15, 7.5, 10, 7.5, 10, 6, 10, 10, 10, 10, 6, 15, 7.5] 
